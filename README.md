...
General:
- Use HTML + CSS (optional minimal JavaScript for navigation/animations)
...
- Include tabs:
  ...
  + About
  + Contact
- Smooth transitions when switching sections or pages
...
- Hero section:
  ...
  + Strong short tagline
  + CTA button: "View My Work"
- Add avatar or featured visual on the right
- Add subtle animation (fade-in)

- Featured Projects Preview:
  + Show 2–3 highlighted works
...
- Each project card:
  ...
  + Project name
  + Category (Poster, Branding, Photobook, etc.)
- Clean alignment (2–3 columns)
- Hover effects:
  + Scale up slightly
  + Show overlay text

3. Project Detail (Optional but recommended):
- When clicking a project:
  + Open a detail page or modal
  + Include:
    * Project title
    * Description
    * Process / concept
...
4. About Page:
- Short introduction (clear and confident)
- Skills (Design tools, strengths)
...
- Fade-in on scroll
- Subtle transitions (0.3s–0.5s)

UX:
- Easy to navigate
- Focus on visual work first
- Avoid clutter

Important:
- Use real images (not placeholders)
- Keep layout structured and consistent
- Make it look like a professional Behance/Dribbble-level portfolio

Output:
- Separate HTML files (home, works, about, contact)
- One shared CSS file
